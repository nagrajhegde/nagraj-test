 ...
 */
public class MycustomextensionManager extends GeneratedMycustomextensionManager
{
	/** Edit the local|project.properties to change logging behavior (properties 'log4j.*'). */
	private static final Logger LOG = Logger.getLogger(MycustomextensionManager.class.getName());
	 ...
	 */
	public static MycustomextensionManager getInstance()
	{
		return (MycustomextensionManager) Registry.getCurrentTenant().getJaloConnection().getExtensionManager()
				.getExtension(MycustomextensionConstants.EXTENSIONNAME);
	}
	 ...
	 */
	public MycustomextensionManager() // NOPMD
	{
		if (LOG.isDebugEnabled())
		{
			LOG.debug("constructor of MycustomextensionManager called.");
		}
	}
